<button type="button" class="edit-btn btn btn-warning btn-sm" data-toggle="modal" data-target="#update_someone_{{ $someone -> id }}">
	<span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
</button>
<div class="modal fade" id="update_someone_{{ $someone -> id }}" tabindex="-1" role="dialog" aria-labelledby="edit_people_label">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				<h4 class="modal-title" id="update_someone_label">Update people</h4>
			</div>
			<form action="{{ route('update_someone') }}" method="POST">
